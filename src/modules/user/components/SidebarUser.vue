dvdvxxzzvxvcxvcxv<script setup lang="ts">
          ...
          >
            <Avatar class="h-8 w-8 rounded-lg">
              ...
              <AvatarFallback class="rounded-lg">
                {{ userStore.isLoggedIn ? userStore.name?.charAt(0) : t("sidebarUser.guestInitial") }}
              </AvatarFallback>
            </Avatar>
