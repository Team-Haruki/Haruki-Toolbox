...
import { SEARCH_ENTRY_TYPES, buildSearchIndex, searchIndexEntries } from "@/modules/search/lib/search-index"
...
export function useGlobalSearch() {
  ...
  const results = computed(() => searchIndexEntries(entries.value, query.value))
