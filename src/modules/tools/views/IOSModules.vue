      ...
      <div class="space-y-1 w-full">
        ...
        <AlertDescription class="space-y-1.5 leading-relaxed mt-2 text-muted-foreground">
          <p>
            ...
            <a href="https://neo.haruki.seiunx.com/toolbox-tutorial/ios-module.html" target="_blank" rel="noopener noreferrer" class="font-medium underline underline-offset-4 text-primary hover:text-primary/80 transition-colors">
