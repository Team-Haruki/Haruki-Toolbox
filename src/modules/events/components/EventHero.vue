...
<template>
  <div class="relative overflow-hidden rounded-xl border bg-card shadow-sm" data-slot="event-hero">
    ...
    <div class="relative flex flex-col items-center gap-3 p-4 sm:flex-row sm:p-5">
      <button
        type="button"
        class="group relative aspect-[2/1] w-full max-w-sm shrink-0 overflow-hidden rounded-lg bg-muted/60 shadow-sm ring-1 ring-border focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-none sm:w-72"
      ...
      <div class="flex min-w-0 flex-1 flex-wrap items-center justify-center gap-2 sm:justify-start">
        <button
          type="button"
