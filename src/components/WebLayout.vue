...
<template>
  <SidebarProvider>
    <Sidebar v-bind="props">
      <SidebarHeader class="border-b px-3 py-2 h-16 justify-center items-center">
                ...
                <SidebarMenuSub>
                  <SidebarMenuSubItem v-for="subItem in item.items || []" :key="subItem.title">
                    <SidebarMenuSubButton as-child>
                      <router-link v-if="subItem.url" :to="subItem.url" class="flex items-center gap-2">
    ...
    <SidebarInset>
      <header
          class="flex h-16 items-center border-b px-4 gap-2 text-base-content bg-gray-200 dark:bg-cyan-900 overflow-hidden flex-nowrap">
        ...
        <div class="flex items-center flex-shrink-0 whitespace-nowrap">
          <router-link to="/" class="flex items-center flex-shrink-0 whitespace-nowrap">
            <div class="text-lg font-bold leading-none flex-shrink-0 whitespace-nowrap">Haruki工具箱</div>
          </router-link>

        </div>
        <Separator orientation="vertical" class="mx-1 !h-6 bg-blue-300 dark:bg-cyan-700 hidden sm:inline-flex"/>
        <div
            v-if="showPageTitle"
      ...
      <SidebarFooter class="border-t p-4 text-center text-sm text-muted-foreground bg-fuchsia-50 dark:bg-gray-800">
