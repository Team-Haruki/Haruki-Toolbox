...
export default {
  "deckRecommend": {
    ...
    "result": {
      ...
      "empty": "暂无推荐结果。",
      "missingUserDataTitle": "还没有可用于组卡的游戏数据",
      "missingUserDataDescription": "所选游戏账号尚未上传所需数据。请先前往数据上传页上传 Suite 数据；使用烤森模式时还需要上传 MySekai 数据，然后再回来重试。",
      "uploadDataAction": "前往上传数据",
      "deckTitle": "卡组 #{index}",
      "score": "Live分数 {score}",
