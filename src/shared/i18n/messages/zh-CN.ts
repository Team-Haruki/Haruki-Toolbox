export const zhCN = {
  ...
  adminSessions: {
    title: "会话管理",
    description: "查看和管理您的管理员会话",
    reauthButton: "重新认证",
    currentTag: "当前",
    empty: "暂无会话",
    dateFallback: "—",
    ttlFormat: "{hours}小时 {minutes}分钟",
    table: {
      sessionId: "会话ID",
      expiresAt: "过期时间",
      ttl: "剩余TTL",
    ...
    deleteDialog: {
      title: "确认注销会话",
      description: "确定要注销该会话吗？对应设备将需要重新登录。",
      cancel: "取消",
      confirm: "确认注销",
    },
    toast: {
      ...
      loadFailedFallback: "加载失败",
      deleteSuccess: "会话已注销",
      deleteFailedTitle: "注销失败",
      deleteFailedFallback: "注销失败",
      reauthSuccess: "已重新认证",
      reauthFailedTitle: "重新认证失败",
      reauthFailedFallback: "重新认证失败",
    },
  },
  adminConfig: {
    publicApiKeys: {
  ...
  oauth: {
    ...
    consent: {
      ...
      invalidDescription: "缺少必要参数，请检查授权链接是否完整。",
      backHome: "返回首页",
      toast: {
        failedTitle: "授权失败",
