export const zhCN = {
  ...
  cardBox: {
    ...
    entryLink: "我的卡箱",
    noAccountHint: "绑定并选择一个游戏账号后即可查看卡箱。",
    dataAsOf: "数据更新于 {time}",
    refresh: "刷新",
    loadError: "卡箱数据加载失败",
    retry: "重试",
  ...
  training: {
    layout: {
      title: "角色养成",
      description: "基于已上传的游戏数据查看挑战 Live、综合力加成、区域道具、羁绊、队长统计与角色任务。",
    },
    tabs: {
      challenge: "挑战信息",
      power: "加成信息",
    ...
    bonds: {
      title: "羁绊",
      noAccountHint: "绑定并选择游戏账号后查看羁绊信息。",
      loadError: "羁绊数据加载失败。",
      retry: "重试",
      refresh: "刷新",
      dataAsOf: "数据时间:{time}",
    ...
    leader: {
      title: "队长统计",
      description: "各角色的队长游玩次数与 EX 任务进度",
      dataAsOf: "数据同步于 {time}",
      refresh: "刷新",
      retry: "重试",
