export const zhCN = {
  ...
  tools: {
    ...
    pointCalculator: {
      ...
      tips: {
        title: "小提示",
        boostConfig: "控分之前请务必确保您的 Live Boost 配置正确，谨防控分失败。",
      ...
      fields: {
        ...
        bonusRange: "自定义加成范围",
        bonusRangeHelp: "只搜索该范围内的活动加成，默认按 100% 到 435% 计算。",
        customBonusFloor: "自定义加成下限",
        customBonusFloorPlaceholder: "默认 100",
        customBonusCap: "自定义加成上限",
        customBonusCapPlaceholder: "默认 435",
        bonusRangeInvalid: "加成范围需要是 100 到 435 之间的整数，且下限不能大于上限。",
        boostIndex: "Live Boost 档位",
        boostIndexAll: "全部档位",
      ...
      result: {
        ...
        noMatchDescription: "请尝试调整目标 Pt、Live Boost 档位或自定义加成上限。",
      },
    },
  },
  deckRecommend: {
    ...
    options: {
      ...
      bonus: {
        title: "加成条件",
        description: "指定目标加成，并可补充自定义混活加成条件。",
      },
      eventSimulation: {
        title: "模拟活动",
      ...
      filters: {
        title: "高级过滤",
        description: "按多个团体或属性限制可用卡牌，也可以临时提高本地数据里的区域道具等级。",
        none: "不限制",
        ...
        boost: "体力消耗",
        boostPlaceholder: "仅作为推荐条件记录",
        invalid: "体力消耗需要是 0-10 的整数；区域道具等级需要是大于 0 的整数。",
      },
      constraints: {
        title: "卡组约束",
        ...
        cardSearchPlaceholder: "搜索卡牌名、#ID、属性、稀有度或拼音...",
        cardEmpty: "没有找到卡牌。",
    ...
    result: {
      ...
      cardTotalPowerShort: "总 {value}",
      cardBasePower: "基础 {value}",
      cardBasePowerShort: "基础 {value}",
      cardLevel: "Lv.{value}",
      masterRank: "突破 {value}",
