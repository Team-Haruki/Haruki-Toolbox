  ...
  deckRecommend: {
    ...
    options: {
      ...
      bonus: {
        ...
        description: "Set target bonuses and optionally add custom mixed-event bonus conditions.",
      },
      eventSimulation: {
      ...
      multiLive: {
        ...
        description: "Used by Multi Live and Cheerful Carnival. Leave teammate power and skill value empty to approximate teammates with the current deck.",
      ...
      filters: {
        ...
        description: "Limit available cards by multiple units or attributes, and optionally override local area item levels.",
        none: "No limit",
      ...
      constraints: {
        ...
        cardSearchPlaceholder: "Search card name, #ID, attribute, rarity, or pinyin...",
    ...
    result: {
      ...
      cardTotalPowerShort: "Total {value}",
      cardBasePower: "Base {value}",
      cardBasePowerShort: "Base {value}",
      cardLevel: "Lv.{value}",
