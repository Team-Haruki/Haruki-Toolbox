export const enUS = {
  ...
  userSettings: {
    ...
    sekaiData: {
      title: "Sekai data cache",
      description: "Manage local IndexedDB caches for master data and music metas by server region. Master data reads current_version.json and chooses dataVersion/cdnVersion by region; music metas uses HEAD validators (ETag, Last-Modified, Content-Length) before downloading with a cache-busting parameter. Basic updates fetch selector tables, deck updates fill the wasm recommendation tables, and same-region tasks are merged into a queue.",
      region: "Region",
      ...
      queueDescription: "Same-region checks, downloads, and cache writes run serially in the background. Existing cache remains usable until the update finishes.",
  ...
  deckRecommend: {
    ...
    description: "Choose account, data region, mode, and song parameters, then run recommendation with wasm in the browser.",
    select: {
    ...
    modes: {
      ...
      maxPower: "Strongest deck (power)",
      maxSkill: "Strongest deck (skill value)",
    },
    liveTypes: {
      solo: "Solo Live",
      multi: "Multi Live",
    ...
    runner: {
      ...
      phases: {
        ...
        initializing: "Initializing wasm engine...",
    ...
    result: {
      ...
      elapsed: "wasm total elapsed {ms} ms",
      totalElapsed: "Recommendation total elapsed {ms} ms",
      dataElapsed: "Data fetch",
      engineDataElapsed: "wasm data preparation",
    ...
    dataStatus: {
      title: "Master Data",
      description: "Shows the selected region's master and music metas cache. Master checks the version file, metas is validated with HEAD, and cached data stays available while the background queue updates versions and timestamps.",
      region: "Region",
      masterVersion: "Display version",
    ...
    dataQueue: {
      title: "Update Queue",
      description: "Same-region data requests are merged and queued to avoid selector refresh spikes. The queue shows whether files are being checked, downloaded, or written.",
      empty: "No update tasks.",
      phases: {
        queued: "Queued",
        checking: "Checking version",
        "fetching-master": "Fetching master",
