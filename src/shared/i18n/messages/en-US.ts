export const enUS = {
  ...
  deckRecommend: {
    ...
    dataStatus: {
      title: "Master Data",
      description: "Cache status and background update controls for the selected region.",
      region: "Region",
    ...
    dataQueue: {
      title: "Update Queue",
      description: "Master data and music metas are checked and written in the background.",
