export const enUS = {
  ...
  adminSessions: {
    title: "Session management",
    description: "View and manage your admin sessions",
    reauthButton: "Re-authenticate",
    currentTag: "Current",
    empty: "No sessions",
    dateFallback: "—",
    ttlFormat: "{hours}h {minutes}m",
    table: {
    ...
    deleteDialog: {
      ...
      description: "Sign out this session? The corresponding device will need to sign in again.",
      cancel: "Cancel",
      confirm: "Confirm sign-out",
    },
    toast: {
      loadFailedTitle: "Failed to load sessions",
      loadFailedFallback: "Load failed",
      deleteSuccess: "Session signed out",
      deleteFailedTitle: "Failed to sign out session",
      deleteFailedFallback: "Sign-out failed",
      reauthSuccess: "Re-authenticated",
      reauthFailedTitle: "Re-authentication failed",
      reauthFailedFallback: "Re-authentication failed",
    },
  },
  adminConfig: {
    publicApiKeys: {
  ...
  oauth: {
    ...
    consent: {
      ...
      invalidDescription: "Required parameters are missing. Please check the authorization URL.",
