  ...
  tools: {
    ...
    pointCalculator: {
      ...
      fields: {
        ...
        bonusRangeHelp: "Only searches event bonuses within this range. Defaults to 100%-435%.",
        ...
        bonusRangeInvalid: "Bonus range must use integers from 100 to 435, and the floor cannot be greater than the cap.",
  ...
  deckRecommend: {
    ...
    options: {
      ...
      filters: {
        ...
        description: "Limit available cards by characters, units, or attributes, and optionally override local area item levels.",
        none: "No limit",
